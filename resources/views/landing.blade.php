...
@section('content')
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="offer-info">
                        ...
                        <ul>
                            ...
                            <li>Первичная консультация онлайн (бесплатно)</li>
                            ...
                            <li>Проживание в отеле/ квартире / доме ( на ваш выбор)</li>
                ...
                <div class="col-md-6">
                    <div class="offer-info">
                        ...
                        <ul>
                            <li>Подготовка документов для въезда в Россию (виза, приглашение)</li>
                            <li>Перевод документов на русский язык</li>
                            <li>Перевод заключения на английский язык, после прохождения лечения</li>
                            <li>Переводчик</li>
                        </ul>
                
                        <p>По вашему желанию может быть организован тур по городу и окрестностям Республики Башкортостан  - нам есть что вам показать ( кнопка виды Башкирии, курорты)</p>
                    </div>
                </div>
            </div>
    ...
    <section id="visa" class="section visa pt-5">
        ...
        <div class="row">
            <div class="col-md-6">
                Обыкновенная туристическая (код 004) — оформляется на основании туристического приглашения, иностранцам, желающим посетить Россию в туристических целях (посещение выставок, культурных мероприятий, экскурсий, знакомство с достопримечательностями нашей страны и просто прогулки по нашим замечательным улицам).
...
(Цель поездки указываемая в приглашении: ТУРИЗМ, АВТОТУРИЗМ, ТУРИЗМ ЦЕЛЕВОЙ, ТУРИЗМ-ОХОТА)
Самый быстрый способ оформить краткосрочный визит в Россию, с туристической целью поездки. Для получения визы, в посольство достаточно предоставить копию приглашения (распечатанную копию или факсимильную)

            </div>
            <div class="col-md-6">
                Обыкновенная частная (код 002) — виза оформляется на основании Частного приглашения, оформленное по ходатайству гражданина РФ имеющего постоянную регистрацию на территории РФ. Документы на приглашение сдаются в районом отделении Федеральной Миграционной Служубы. Цель поездки в приглашение указана как ЧАСТНАЯ.
